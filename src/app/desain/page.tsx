...
const GraphicDesignPage: React.FC = () => {
    ...
    if (!graphicDesignDetail) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-100">
                <p className="text-xl text-red-600">Error: Graphic Design data not found.</p>
    ...
    return (
        // ==================Bagian Utama====================
        <section id="graphic-design-detail-page" className="py-20 md:py-32 bg-gray-100 min-h-screen">
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-lg shadow-xl">
                    ...
                    {/* ==================Bagian Alat Kreatif==================== */}
                    <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b pb-4">Creative Tools</h2>
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b pb-4">Design Portfolio</h2>
                        ...
                        {graphicDesignDetail.projects.map((project: Project) => (
                            <div key={project.name} className="bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                                ...
                                {project.link && project.link !== '#' && (
                                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline font-medium flex items-center">
                                        View Design
