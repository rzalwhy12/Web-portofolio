...
import Link from 'next/link'; // Untuk navigasi kembali ke halaman utama
import { skillsData, SkillDetail, Project } from '../../data/skillsData'; // Sesuaikan path
...
const WebDevelopmentPage: React.FC = () => {
    ...
    if (!webDevDetail) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-100">
                <p className="text-xl text-red-600">Error: Web Development data not found.</p>
    ...
    return (
        // ==================Bagian Utama====================
        <section id="web-development-detail-page" className="py-20 md:py-32 bg-gray-100 min-h-screen">
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-lg shadow-xl">
                    ...
                    {/* ==================Bagian Proyek Selesai==================== */}
                    <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b pb-4">Completed Projects</h2>
                        ...
                        {webDevDetail.projects.map((project: Project) => (
                            <div key={project.name} className="bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                                ...
                                {project.link && project.link !== '#' && (
                                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium flex items-center">
                                        View Project
